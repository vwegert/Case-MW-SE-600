	...
	color("DodgerBlue")
		union() {
			difference() {
				...
				translate([PRI_COVER_INNER_CLEARANCE - COVER_SUPPORT_PILLAR_SIZE / 2 - COVER_INNER_SUPPORT_PILLAR_DISTANCE_PS,
					       PRI_COVER_MAINS_COMP_WIDTH - COVER_SUPPORT_PILLAR_SIZE / 2 - COVER_INNER_WIDTH_CORRECTION/2 + PRI_COVER_MAINS_COMP_WALL_THICKNESS, 
					       0])
					_lp_screw_hole();
			}
